...
P3 = ca.vertcat(0, 0)
P1 = P3 + link_vector(theta3, l3)
P5 = P1 + link_vector(theta1, l1)
P2 = P5 - link_vector(theta2, l2)
P4 = P2 - link_vector(theta4, l4)


G3 = P1 - link_vector(theta3, r3)
G1 = P5 - link_vector(theta1, r1)
G5 = P5 + link_vector(theta5, r5)
G2 = P5 - link_vector(theta2, r2)
G4 = P2 - link_vector(theta4, r4)
...
skeleton_fn = ca.Function("skeleton", [q], [P3, P1, P5, P2, P4])
